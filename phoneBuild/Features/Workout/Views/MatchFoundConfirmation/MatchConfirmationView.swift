...
struct MatchConfirmationView: View {
    ...
    private let successGreen = Color(red: 0.18, green: 0.78, blue: 0.42)
    private let successBlue = Color(red: 0.12, green: 0.64, blue: 0.78)
        ...
        NavigationStack {
            VStack(spacing: 34) {
                ...
                VStack(spacing: 10) {
                    ...
                    Text("Your workout buddy is ready. \nChoose a sport and challange to get started")
        ...
        ZStack {
            ...
            ZStack {
                Circle()
                    .fill(
                        RadialGradient(
                            gradient: Gradient(colors: [successGreen, successGreen.opacity(0.78)]),
                            center: .center,
                            startRadius: 0,
                            endRadius: 46
                        )
